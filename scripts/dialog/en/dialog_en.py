...
class Dialog():
    ...
    def unequipped(player, equipment):
        s = Constants.BLANK
        if isinstance(equipment, Weapon):
            s = str(player.get_name()) + ' removed ' + str(equipment.get_name()) + '(' + str(equipment.get_atk()) + ')!!'
        if isinstance(equipment, Armor):
            s = str(player.get_name()) + ' removed ' + str(equipment.get_name()) + '(' + str(equipment.get_hp()) + ')!!'
        if isinstance(equipment, Shield):
            s = str(player.get_name()) + ' removed ' + str(equipment.get_name()) + '(' + str(equipment.get_ar()) + ')!!'
